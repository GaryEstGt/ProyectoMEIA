...
public class ManejoUsuariosEnListas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtListaCreada = new javax.swing.JTextArea();
        jScrollPane4 = new javax.swing.JScrollPane();
        txtListaAsociada = new javax.swing.JTextArea();
        ...
        txtListaCreada.setEditable(false);
        txtListaCreada.setColumns(20);
        txtListaCreada.setRows(5);
        jScrollPane3.setViewportView(txtListaCreada);

        txtListaAsociada.setEditable(false);
        txtListaAsociada.setColumns(20);
        txtListaAsociada.setRows(5);
        jScrollPane4.setViewportView(txtListaAsociada);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if(!txtUsuarioBuscar.getText().toString().isEmpty()){
            try {
                if(VerSiExisteUsuario(Lista_Usuario.buscarUsuario(txtUsuarioBuscar.getText().toString()))){
                    try{
                        lblNombreUsuario.setText(txtUsuarioBuscar.getText().toString());
                LinkedList<UsuarioLista> usuarioLista = Lista_Usuario.buscarUsuarioLista(txtUsuarioBuscar.getText().toString());
                LinkedList<Lista> listas = Lista_Usuario.buscarListas(txtUsuarioBuscar.getText().toString());                
                ...
                if(usuarioLista.size() != 0){
                    ...
                    cadena+= "Nombre: " + usuarioLista.get(i).getNombreLista() + "       Descripción: " + usuarioLista.get(i).getDescripcion() + "\n";
                    }
                
                    txtListaAsociada.setText(cadena);                                    
                }
                else{
                    txtListaAsociada.setText("El usuario no esta asociado a ninguna lista");
                }
                
                if(listas.size() != 0){
                    cadena = "";
                    for (int i = 0; i < listas.size(); i++) {
                        cadena+= "Nombre: " + listas.get(i).getNombreLista() + "       Descripción: " + listas.get(i).getDescripcion() + "\n";
                    }
                    
                    txtListaCreada.setText(cadena);
                }
                else{
                    txtListaCreada.setText("El usuario no ha creado ninguna lista");
                }                                                                
            }catch(IOException e){
    ...
    private javax.swing.JTextArea txtListaAsociada;
    private javax.swing.JTextArea txtListaCreada;
